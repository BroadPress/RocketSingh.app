  ...
  return (
    <ServicePageLayout
      ...
      faqs={[
        ...
        { id: 3, question: "How often should facades be cleaned?", answer: "We recommend annual facade cleaning for most buildings, or more frequently in high-pollution urban areas like New Delhi." },
