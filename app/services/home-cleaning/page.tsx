...
export default function HomeCleaning() {
  return (
    <ServicePageLayout
      ...
      heroTitle="Home Cleaning Services in India"
      ...
      introParagraphs={[
        "Our home cleaning services in India ensure every corner of your house is spotless. We use trained professionals, modern equipment, and eco-friendly products for deep cleaning, carpet cleaning, sofa cleaning, AC cleaning, and post-construction cleanup.",
      ...
      faqs={[
        ...
        { id: 4, question: "How often should I book deep cleaning in India?", answer: "We recommend deep cleaning every 3 to 6 months, depending on usage, lifestyle, and property type." },
