...
const SchoolCleaning = () => {
  ...
  return (
    <div className="flex flex-col gap-0 mb-40">
      <Head>
        <title>School Cleaning Services in India</title>
        <meta
          name="description"
          content="Professional school cleaning services in India including classroom cleaning, hallway and restroom sanitization, dusting, mopping, and waste management for hygienic learning environments."
        />
      ...
      <div className="relative w-full h-[560px] flex items-center justify-center text-white mb-20">
        <img
          ...
          alt="School Cleaning Services in India"
        ...
        <div className="relative z-10 max-w-4xl text-center px-4">
          <div className="flex flex-col items-center justify-center h-[277px] px-4 py-8 text-center">
            ...
            <h1 className="mb-4 text-5xl font-bold text-white md:text-[52px]">
              School Cleaning Services in India
            </h1>
      ...
      <div className="mx-auto px-5 py-10 max-w-7xl text-center">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Our school cleaning services in India cover classrooms, hallways, restrooms, and common areas. We use trained professionals, modern equipment, and eco-friendly products for thorough cleaning and sanitization.
        </p>
        <p className="text-gray-700 leading-relaxed mb-6">
