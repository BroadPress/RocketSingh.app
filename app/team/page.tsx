          ...
          <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
            ...
            <div className="flex-1 space-y-5 leading-relaxed">
              ...
              <p className="text-[1em]">
                Ramesh Koirala leads his family legacy of Cleaning Services using latest technologies under RocketSingh as Director, ensuring top-quality cleaning services across New Delhi. He focuses on efficiency, customer satisfaction, and eco-friendly solutions for homes and offices.
              </p>
              <p className="text-[1em]">
